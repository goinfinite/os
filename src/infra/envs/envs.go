...
const (
	...
	PrimaryVirtualHostPublicDir        string = ApplicationRootDir + "/html"
	...
	PkiConfDir                         string = ApplicationRootDir + "/conf/pki"
	CronLogDir                         string = ApplicationRootDir + "/logs/cron"
	WebServerLogDir                    string = ApplicationRootDir + "/logs/nginx"
	TrashDir                           string = ApplicationRootDir + "/.trash"
