    ...
    "paths": {
        ...
        "/v1/vhosts/": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Only hostname is required.\u003cbr /\u003etype may be 'top-level', 'subdomain', 'wildcard' or 'alias'. If is not provided, will be 'top-level'. If type is 'alias', 'parentHostname' will be required.",
