...
RUN install_packages ca-certificates wget curl tar procps debian-archive-keyring lsb-release gnupg2 haveged rsync zip unzip bind9-dnsutils build-essential certbot \
